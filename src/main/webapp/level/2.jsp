...
<%
				...
				if (request.getMethod().equals("POST") && password.equals("")) {
					response.sendRedirect("http://localhost:8080/wiprostore/level/3.jsp"); //replacelink
					return;
				}
				else{
%>
	<link href="../bootstrap/signin.css" rel="stylesheet">	
		<div class="container">
			<form class="form-signin" method="POST">
				...
				out.println("<!--"+rnd_pwd+"-->");			
				%>				
				<h2 class="form-signin-heading">Level 2</h2>
