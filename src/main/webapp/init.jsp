	...
	public void jspInit() {
    	...
    	try {
			...
			if (!rs.next()) {
				...
				//Ranking table
				c.prepareStatement("CREATE CACHED TABLE RankingTable(" +
						"typeid INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY, " +
						"name varchar(50) NOT NULL, votes INTEGER NOT NULL)").execute();
				
				c.prepareStatement("INSERT INTO RankingTable(name, votes) VALUES ('Monish1', 4000)").execute();
				c.prepareStatement("INSERT INTO RankingTable(name, votes) VALUES ('Monish2', 972)").execute();
				c.prepareStatement("INSERT INTO RankingTable(name, votes) VALUES ('Monish3', 501)").execute();
				c.prepareStatement("INSERT INTO RankingTable(name, votes) VALUES ('Monish4', 2991)").execute();
				c.prepareStatement("INSERT INTO RankingTable(name, votes) VALUES ('Monish5', 1992)").execute();
				c.prepareStatement("INSERT INTO RankingTable(name, votes) VALUES ('Monish6', 883)").execute();
				c.prepareStatement("INSERT INTO RankingTable(name, votes) VALUES ('Monish7', 1201)").execute();
				c.prepareStatement("INSERT INTO RankingTable(name, votes) VALUES ('Monish8', 1344)").execute();
				c.prepareStatement("INSERT INTO RankingTable(name, votes) VALUES ('Monish9', 1776)").execute();
				c.prepareStatement("INSERT INTO RankingTable(name, votes) VALUES ('Monish10', 3315)").execute();
